...
import { Book as BookIcon, MapPin, Tag, User, Calendar, Loader2 } from 'lucide-react';
...
const BookDetails = ({ book }) => {
  ...
  const isStudent = user && ['student', 'faculty', 'teacher'].includes(user.role);
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="flex items-center">
                ...
                <span className="text-muted-foreground">{book.region?.regionName || 'N/A'}</span>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="flex items-center">
                ...
                <span className="text-muted-foreground">
                  {book.createdAt ? format(new Date(book.createdAt), 'MMMM dd, yyyy') : 'N/A'}
                </span>
              </div>
            </div>
          </div>
