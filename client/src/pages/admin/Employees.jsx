...
import { Pencil, Trash2, Plus, User, DollarSign, Building2, Users } from "lucide-react";
...
const Employees = () => {
  ...
  const filteredEmployees = employees.filter((employee) => {
    ...
    const matchesDepartment = filterDepartment === "" || 
      employee.department?.departmentName?.toLowerCase() === filterDepartment.toLowerCase();
  ...
  return (
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 py-8 min-h-screen mt-16">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold text-blue-800 mb-1">Employee Management</h1>
          <p className="text-green-700">Manage your organization's workforce</p>
        </div>
        {user?.role === "admin" && (
          <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
            <DialogTrigger asChild>
              <Button className="flex items-center gap-2 text-sm font-medium text-white bg-green-600 hover:bg-green-700 shadow-md mt-4 md:mt-0">
                <Plus size={16} />
                Add Employee
              </Button>
            </DialogTrigger>
        ...
        <Card className="border-blue-200 shadow-md bg-gradient-to-r from-blue-50 to-blue-100">
          <CardContent className="flex items-center p-6">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-blue-800">{stats.totalEmployees}</h3>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-blue-200 shadow-md bg-gradient-to-r from-green-50 to-green-100">
          <CardContent className="flex items-center p-6">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-green-800">₵{stats.avgSalary.toLocaleString(undefined, {maximumFractionDigits: 0})}</h3>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-blue-200 shadow-md bg-gradient-to-r from-blue-50 to-green-100">
          <CardContent className="flex items-center p-6">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-blue-800">{Object.keys(stats.departmentCounts).length}</h3>
            </div>
          </CardContent>
        </Card>
      </div>
          ...
          <div className="overflow-x-auto">
            <Table>
              <TableHeader className="bg-gradient-to-r from-blue-100 to-green-100">
                <TableRow>
                  <TableHead className="text-blue-800 font-semibold">Employee</TableHead>
                  ...
                  <TableHead className="text-blue-800 font-semibold">Salary</TableHead>
                  <TableHead className="text-blue-800 font-semibold">Bonus</TableHead>
              ...
              <TableBody>
                {filteredEmployees.map((employee) => (
                  ...
                  >
                    <TableCell>
                      <Link to={`/employee/${employee._id}`} className="flex items-center">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-r from-blue-400 to-green-400 flex items-center justify-center text-white font-bold mr-3">
                    ...
                    <TableCell className="font-medium">₵{employee.bonus.toLocaleString()}</TableCell>
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent className="border-red-200">
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    This action cannot be undone. This will permanently delete the employee record for {employee.user?.name}.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
